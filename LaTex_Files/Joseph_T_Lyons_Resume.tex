...
\begin{tightlySpacedList}
    ...
    \item Contributed to popular open-source software, such as Atom, Rust-Lang,
          and Nushell
    \item Nushell repository maintainer (triage duties)
    \item Collaborated on open-source software that has been deposited into the
...
\\Software Engineer II $\mid$ September 2019 --- Present
\begin{tightlySpacedList}
    ...
    \item Design and build tools to aid in the deployment of our product
    \item Create and maintain open-source python libraries
